// after that point, the  only thing that should be done is to 
// split the file into different files and call them in this main.js
// final repo can be found in lesson #74
// also in final-demo/ folder in this repo
